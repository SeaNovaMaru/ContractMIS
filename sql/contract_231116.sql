...
(
    ...
    `contract_status`           VARCHAR(36)       NOT NULL COMMENT '合同审批状态',
...
(
    ...
    `execution_file`        varchar(256)  DEFAULT NULL COMMENT '处理意见路径',
    `execution_file_name`   varchar(64)   DEFAULT NULL COMMENT '处理意见文件名',
