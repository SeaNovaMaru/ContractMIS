...
public class FileUploadUtils {
    ...
    public static final String getAbsPath(String baseDir, String name)
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException {
        return getAbsoluteFile(baseDir, name).getAbsolutePath();
    }
    ...
    public static final String extractFilename(String name) {
        return StringUtils.format("{}/{}_{}.{}", DateUtils.datePath(),
                FilenameUtils.getBaseName(name), Seq.getId(Seq.uploadSeqType), getExtension(name));
    }
    ...
    public static final String getExtension(String name) {
        ...
        if (StringUtils.isEmpty(extension)) {
            extension = MimeTypeUtils.getExtension(Objects.requireNonNull(name));
        }
        return extension;
    }
}
